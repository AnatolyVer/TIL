...
const Modal27 = ({selectedDay, setSelectedDay} : {selectedDay: number, setSelectedDay: (day: number | null) => void}) => {
    ...
    return (
        <>
            <p className="text-pink-700 mb-2 text-sm lg:text-lg">
                Голос в голове: Зная этот малыш в своё время то, что он встретит настолько прекрасную девушку, как ты, его улыбка осветила бы весь мир..
            </p>
            <Image
                src="/me.jpg"
                width={1000}
