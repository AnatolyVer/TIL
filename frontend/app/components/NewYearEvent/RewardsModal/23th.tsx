...
const Modal23 = ({selectedDay, setSelectedDay} : {selectedDay: number, setSelectedDay: (day: number | null) => void}) => {
    ...
    return (
        <>
            ...
            <p className="text-pink-700 mb-2 text-sm lg:text-lg">
              Голос в голове: интересный факт, днём рождения Деда Мороза считается 18 ноября. Смекааешь, о чём я?
            </p>
            <button
