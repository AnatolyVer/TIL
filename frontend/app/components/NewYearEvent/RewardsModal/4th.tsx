...
import RecipeBookItem from "@/app/components/NewYearEvent/Inventory/RecipeBookItem";

const Modal4 = ({selectedDay, setSelectedDay} : {selectedDay: number, setSelectedDay: (day: number | null) => void}) => {
    ...
    return (
        <>
            <p className="text-pink-700 italic mb-3 text-sm lg:text-lg">
                &#34;Какая добрая и милая женщина.. угостила меня вкуснейшим овсянным печеньем. Даже книгу рецептов дала!
                Дома обязательно изучу рецепты, выберу, что можно приготовить, чтобы встретить Новый Год&#34;
            </p>
