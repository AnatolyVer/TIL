...
import MainModal from "@/app/events/new_year_miracle/RewardsModal/mainModal";
...
export default function Page() {
    ...
    return (
        <div className="relative min-h-[300vh] lg:min-h-[280vh] bg-[#222] overflow-hidden flex items-start justify-center">
            <Link href="/events/new_year_miracle/outside" className={`${config.locations.outside ? "" : "hidden"} z-50`}>
                <Image
                    src="/outside.jpg"
                    alt="outside"
                    width={396}
            ...
            <Link href="/events/new_year_miracle/cooking" className={`${config.taken_rewards[8] ? "" : "hidden"} z-50`}>
                <Image
                    src="/kitchen.jpg"
                    alt="kitchen"
                    width={396}
            ...
            <Link href="/events/new_year_miracle/room" className={`${config.taken_rewards[17] ? "" : "hidden"} z-50`}>
                <Image
                    src="/room.jpg"
                    alt="room"
                    width={396}
