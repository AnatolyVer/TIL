...
const Modal25 = ({selectedDay, setSelectedDay} : {selectedDay: number, setSelectedDay: (day: number | null) => void}) => {
    ...
    return (
        <>
            ...
            <p className="text-pink-700 mb-2 text-sm lg:text-lg">
                Голос в голове: Я думаю ты уже знаешь, кто я. Нет смысла больше носить маску.
            </p>
            <button
